...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            {{ Breadcrumbs::render('aboutsEdit', $about) }}
        </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-created_at">{{ $about->title }}</h3>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title"
                                        ...
                                        placeholder="Заголовок" value="{{ $about->title }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title_en"
                                        ...
                                        placeholder="english" value="{{ $about->title_en }}">
                                </div>

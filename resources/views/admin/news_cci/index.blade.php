...
<section class="content-header">
    <div class="container-fluid">
        <h5>{{ Breadcrumbs::render('newscci') }}</h5>
    </div><!-- /.container-fluid -->
</section>
<!-- Main content -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <a href="{{ route('news_cci.create') }}" class="btn btn-primary mb-3">Добавить
                            новость</a>
                        @if (count($news))
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('news_cci.edit', $n->id) }}"
                                                class="btn btn-info btn-sm float-left mb-1 mr-1">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <form
                                                action="{{ route('news_cci.destroy', $n->id) }}"

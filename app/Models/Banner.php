...
class Banner extends Model
{
    ...
    public static function uploadImageRu(Request $request, $image = null)
    {
        if ($request->hasFile('thumbnail')) {
            ...
            $folder = date('Y-m-d');
            return $request->file('thumbnail')->store("images/{$folder}/banner_ru");
        }
        return null;
    }
    ...
    public static function uploadImageEn(Request $request, $image = null)
    {
        if ($request->hasFile('thumbnail_en')) {
            ...
            $folder = date('Y-m-d');
            return $request->file('thumbnail_en')->store("images/{$folder}/banner_en");
        }
        return null;
    }
    ...
    public static function uploadImageTk(Request $request, $image = null)
    {
        if ($request->hasFile('thumbnail_tk')) {
            ...
            $folder = date('Y-m-d');
            return $request->file('thumbnail_tk')->store("images/{$folder}/banner_tk");
        }
        return null;
    }
